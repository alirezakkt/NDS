...
# Function to validate the fetched candles
def validate_candles(candles):
    required_columns = ['Open', 'High', 'Low', 'Close', 'Volume']
    # Check if all required columns exist and have no NaN values
    ...
    while True:
        ...
        if not candles.empty and not candles.isnull().all().any():
            ...
            if validate_candles(candles):
                ...
                print("Fetched candles contain invalid data. Skipping save.")
